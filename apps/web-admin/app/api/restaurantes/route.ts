  ...
  try {
    const rows = await sql`
      SELECT id, slug, nombre, subtitulo, direccion_fisica, celular,
             ...
             imagen_url, logo_url, activo, calificacion, num_resenas,
             creado_en
      FROM restaurantes
  ...
  try {
    ...
    const inserted = await sql`
      INSERT INTO restaurantes (
        slug, nombre, subtitulo, direccion_fisica, celular,
        tipo_socio, monto_minimo, tiempo_estimado,
        imagen_url, logo_url, activo
      ) VALUES (
        ${d.slug}, ${d.nombre}, ${d.subtitulo || null},
        ${d.direccion_fisica}, ${d.celular || null},
        ${d.tipo_socio}, ${d.monto_minimo}, ${d.tiempo_estimado || null},
        ${d.imagen_url || null}, ${d.logo_url || null}, ${d.activo}
      )
